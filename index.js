...
const killEnemySound = new Audio("./music/killing.mp3");
const gameOverSound = new Audio("./music/gameover.wav");
const heavyWeaponSound = new Audio("./music/heavyWeap.wav");
const hugeWeaponSound = new Audio("./music/hugeWeap.wav");
